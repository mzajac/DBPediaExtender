...
# Changes by Marcin Zając signified by #MZ
...
class WikiExtractor:
    ...
    def __compact(self, wiki_document):
        #MZ: dont collect paragraph names
        page = list()
        paragraph = list()
    ...
    def __get_anchor_tag(self, document_title, link_text):
        ...
        ''' Anchors consist of 2 parts: 
            ...
            * the link to the article that describes it  
            ...
            However some of the links are not links to a article describing the entity described but to a paragraph in another article. In that case the whole link is not very useful and the name of the paragraph is the value to extract.
